...
JAX numpy does not accept units. Therefore, all inputs to these functions must be unitless.
The assumed units are:
- Distance to source: parsecs
- Other distances: au
- Velocity: km/s
- Mass: solar masses
- Angles (PA, i, theta, phi): degrees
- TODO: insert other units here
'''

'''
TODO:
- Add JAX numpy implementation of the functions
- Convert all functions to accept unitless inputs and return unitless outputs
- Add docstrings with units for each function
